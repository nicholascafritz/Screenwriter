  ...
  return (
    ...
    <FileDropZone onFiles={handleDropFiles} className="h-screen">
      <div className="flex h-screen flex-col bg-background">
        {/* Top Bar */}
        <header className="flex h-12 items-center justify-between border-b border-border bg-[var(--color-bg-raised)] px-4 flex-shrink-0">
          ...
          <div className="flex items-center gap-2">
            {/* View mode toggle */}
            <div className="flex items-center rounded-md border border-border bg-[var(--color-bg-base)] p-0.5">
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          {showOutline && (
            <>
              <div
                className="flex-shrink-0 border-r border-border overflow-hidden flex flex-col bg-[var(--color-bg-raised)]"
                style={{ width: outlineWidth }}
              >
                {/* Tab bar */}
                <div className="flex items-center gap-0.5 px-2 py-1.5 border-b border-border bg-[var(--color-bg-base)]/30 shrink-0">
                  <button
        ...
        {/* Status Bar */}
        <footer className="flex h-7 items-center justify-between border-t border-border bg-[var(--color-bg-base)] px-3 text-caption text-muted-foreground flex-shrink-0">
          <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-3">
            {isAIActive && (
              <span className="text-primary text-tiny font-medium ai-active-pulse">
                AI editing...
              </span>
            )}
            ...
            <span className="text-muted-foreground/60">Fountain</span>
          </div>
        </footer>
      </div>
