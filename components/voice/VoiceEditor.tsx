...
const ASPECT_CONFIGS: AspectConfig[] = [
  ...
  },
  {
    ...
    styles: [
      ...
      { value: 'fractured-classical', label: 'Fractured Classical' },
      { value: 'custom', label: 'Custom' },
    ],
  },
  {
    ...
    styles: [
      ...
      { value: 'detached-vivid', label: 'Detached Vivid' },
      { value: 'custom', label: 'Custom' },
    ],
  },
  {
    ...
    styles: [
      ...
      { value: 'controlled-drift', label: 'Controlled Drift' },
      { value: 'custom', label: 'Custom' },
    ],
  },
  {
    ...
    styles: [
      ...
      { value: 'wry-uncanny', label: 'Wry Uncanny' },
      { value: 'custom', label: 'Custom' },
    ],
  },
];
